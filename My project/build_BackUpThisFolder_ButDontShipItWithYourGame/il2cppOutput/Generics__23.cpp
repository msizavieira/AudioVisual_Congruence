...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisEventDescription_t2904DB225583633AC5E150B2FF1EA269955FB28C_mB5B00E26E507074819F9A7450C16688576DC4275(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 57));
	}
	try
	{
		{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m857D2EE4A514331EE2F6BAC7300F1F7CB94359F4(__this, L_3, ((*(EventDescription_t2904DB225583633AC5E150B2FF1EA269955FB28C*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
